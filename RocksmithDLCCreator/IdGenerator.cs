...
namespace RocksmithDLCCreator
{
    class IdGenerator
    {
        ...
        {
            return String.Format("{0}{1}{2}{3}-0000-0000-0000-000000000000", GetHexRandomByte(),
                                                                            GetHexRandomByte(),
                                                                            GetHexRandomByte(),
                                                                            GetHexRandomByte()).ToLower();
        }
        public static string Id()
        {
            return String.Format("{0}{1}{2}{3}{4}{5}{6}{7}{8}", GetHexRandomByte(),
                                                                GetHexRandomByte(),
                                                                GetHexRandomByte(),
                                                                GetHexRandomByte(),
                                                                GetHexRandomByte(),
