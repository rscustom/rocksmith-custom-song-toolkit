...
namespace RocksmithToolkitGUI.DLCPackageCreator
{
    public partial class DLCPackageCreator : UserControl
    {
        ...
        private string CurrentOFDToneImportFilter
        {
            get
            {
                ...
                if (rbRs2012.Checked)
                    ...
                    filter += "|Rocksmith 2014 Game Save Profile (*_prfldb)|*_prfldb|Rocksmith 2014 Tone File (*.tone2014.xml)|*.tone2014.xml";
        ...
        public void SaveTemplateFile(string templateDir = null)
        {
            ...
            string templatePath;
            var fileName = StringExtensions.GetValidShortFileName(ArtistSort, SongTitleSort, CurrentGameVersion.ToString(), ConfigRepository.Instance().GetBoolean("creator_useacronyms"));
        ...
        public void btnPackageGenerate_Click(object sender = null, EventArgs e = null)
        {
            ...
            if (String.IsNullOrEmpty(unpackedDir))
                templateDir = packageData.Arrangements[0].SongXml.File;
            else
                templateDir = unpackedDir;

            SaveTemplateFile(templateDir);
        }
        ...
        public void btnPackageImport_Click(object sender = null, EventArgs e = null)
        {
            ...
            GlobalExtension.ShowProgress("Reorganized Package Data ...", 35);
            ...
            GlobalExtension.ShowProgress("Loaded Package Data ...", 70);
