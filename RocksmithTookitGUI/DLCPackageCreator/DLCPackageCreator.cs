                ...
                if (CurrentGameVersion == GameVersion.RS2014)
                {
                    ...
                    if (!File.Exists(showlightFile))
                    {
                        var diagResult = MessageBox.Show(String.Format("Warning: Arrangement Showlight not found! File: {0}", showlightFile) + Environment.NewLine +
                                                         "If you click 'Yes' showlight will be  generated for you song." + Environment.NewLine +
                                                         "Or you can click 'No' and create showlights through EOF" + Environment.NewLine + 
                                                         "(the file is generated by EoF for each arrangement, except Vocal).",
