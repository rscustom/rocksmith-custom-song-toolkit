    ...
    public partial class TuningForm : Form
    {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            if (IsBass && Tuning.Tuning.String4 == 0 && Tuning.Tuning.String5 == 0)
                if (MessageBox.Show(String.Format("Are strings 4 and 5 really 0?{0}We recommend filling in all strings fields (to cover guitar tuning).{0}To avoid two of the same tuning for different instruments.{0}{0}Cancel save and fix it now?{0}",
