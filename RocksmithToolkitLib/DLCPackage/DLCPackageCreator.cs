                ...
                try {
                    ...
                    try
                    {
                        ...
                        using (var xblockStream = new MemoryStream())
                        {
                            ...
                            var audioFileNameId = SoundBankGenerator.GenerateSoundBank(dlcName, soundStream, soundbankStream, info.Volume, platform);
                            ...
                            var audioPreviewFileNameId = SoundBankGenerator.GenerateSoundBank(dlcName + "_Preview", soundPreviewStream, soundbankPreviewStream, info.Volume, platform);
